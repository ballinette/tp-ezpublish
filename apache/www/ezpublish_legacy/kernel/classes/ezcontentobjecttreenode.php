...
class eZContentObjectTreeNode extends eZPersistentObject
{
    ...
    */
    function removeThis()
    {
        ...
        ezpEvent::getInstance()->notify( 'location/delete', array($params));
    }
    ...
    */
    function move( $newParentNodeID, $nodeID = 0 )
    {
        ...
        if ( $oldParentNodeID != $newParentNodeID )
        {
            ...
            $params=array(
                'locationId'=> $nodeID,
                'newParentLocationId' => $newParentNodeID
            );

            ezpEvent::getInstance()->notify( 'location/move', array($params));
        }
    }
    ...
    */
    ...
    static function hideSubTree( eZContentObjectTreeNode $node, $modifyRootNode = true )
    {
        ...
        $params=array(
            'locationId' => $nodeID,
            'contentId' => $node->attribute( 'contentobject_id' ),
            'currentVersionNo' => $node->object()->attribute('current_version'),
        );

        ezpEvent::getInstance()->notify( 'location/hide', array($params));
    }
    ...
    static function unhideSubTree( eZContentObjectTreeNode $node, $modifyRootNode = true )
    {
        ...
        ezpEvent::getInstance()->notify( 'location/unhide', array($params));
    }
