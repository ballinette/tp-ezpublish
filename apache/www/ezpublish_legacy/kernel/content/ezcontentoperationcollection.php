...
*/
    ...
    function publishObjectExtensionHandler( $contentObjectID, $contentObjectVersion )
    {
        ...
        $params=array(
            ...
            'versionNo' => $contentObjectVersion
        );
        ezpEvent::getInstance()->notify( 'content/publish', array($params));

        if($contentObjectVersion == 1)
        {
            ezpEvent::getInstance()->notify( 'content/create', array($params));
        }
        else
        {
            ezpEvent::getInstance()->notify( 'content/update', array($params));
        }
