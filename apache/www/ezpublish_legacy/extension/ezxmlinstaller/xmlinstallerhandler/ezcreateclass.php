...
class eZCreateClass extends eZXMLInstallerHandler
{
    ...
    function execute( $xml )
    {
        ...
        foreach ( $classList as $class )
        {
            ...
            $deleteAttributesNode   = $class->getElementsByTagName( 'DeleteAttributes' )->item(0);
            if ($deleteAttributesNode) {
                $deleteAttributeList = $deleteAttributesNode->getElementsByTagName('Attribute');
                foreach ($deleteAttributeList as $deleteAttribute) {
                    $attributesToDelete[] = $deleteAttribute->getAttribute('identifier');
                }
            }
