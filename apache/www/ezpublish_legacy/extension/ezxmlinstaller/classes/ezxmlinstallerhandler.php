...
class eZXMLInstallerHandler
{
    ...
    function getReferenceID( $refInfo )
    {
        ...
        switch( $type )
        {
            ...
            case 'node_remote_id':
            {
                $relContentObjectTree = eZContentObjectTreeNode::fetchByRemoteID( $refID );
                if ( $relContentObjectTree )
                {
                    $referenceID = $relContentObjectTree->attribute('contentobject_id');
                }
            } break;
            ...
            case 'node_remote_id_node_id':
            {
                $relContentObjectTree = eZContentObjectTreeNode::fetchByRemoteID( $refID );
                if ( $relContentObjectTree )
                {
                    $referenceID = $relContentObjectTree->attribute('node_id');
                }
            } break;
        }
        return $referenceID;
