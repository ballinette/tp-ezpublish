    ...
    function &inputTagXML( &$tag, $currentSectionLevel, $tdSectionLevel = null )
    {
        ...
        switch ( $tagName )
        {
            ...
            case 'custom' :
            {
                ...
                {
                    // fetch a template to render the tag
                    ...
                    $tpl->setVariable('customAttributes', $customAttributes);
                    $templateOutput = $tpl->fetch( 'design:content/datatype/view/ezxmltags/custom/' . $name . '.tpl' );
